...
> 好策阅读平台全自动脚本，帮你搞定每学期的英语阅读任务。

[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](LICENSE)
[![Python 3.10+](https://img.shields.io/badge/Python-3.10+-green.svg)](https://www.python.org/)

一个寒假过去，你的好策阅读任务还是 0/20？这个工具帮你在几分钟内完成：模拟阅读进度、AI 写讨论帖和摘抄、TTS 生成朗读音频并上传。自由搭配 LLM（OpenAI / Ollama）和 TTS（API / 本地 Qwen3-TTS），不花钱也能用。

## 功能

- **模拟阅读** — 自动上报阅读时长和章节进度
- **讨论** — AI 生成讨论帖 + 回复，引用真实章节原文，不像 AI 写的
- **摘抄** — AI 生成原文摘抄 + 赏析点评
- **报告** — AI 生成读书报告
- **朗读** — 提取真实章节文本，TTS 生成语音朗读上传
